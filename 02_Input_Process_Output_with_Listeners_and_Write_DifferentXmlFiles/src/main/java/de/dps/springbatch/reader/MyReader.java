...
import de.dps.springbatch.mapper.MyBeanWrapperFieldSetMapper;
...
public class MyReader {
    ...
    @Value("file:${folder.READ.IN}/personalData*.csv")
    ...
    private FieldSetMapper<Person> createFileInfomationMapper() {
        BeanWrapperFieldSetMapper<Person> fieldSetMapper
            = new MyBeanWrapperFieldSetMapper<>();
